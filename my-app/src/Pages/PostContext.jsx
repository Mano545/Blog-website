...
export function PostProvider({ children }) {
  ...
  const fetchPosts = async () => {
    try {
      const response = await fetch("https://blog-website-backend-guxe.onrender.com/posts");
  ...
  const addPost = async (post) => {
    try {
      ...
      const response = await fetch("https://blog-website-backend-guxe.onrender.com/posts/create", {
        method: "POST",
        headers: {
  ...
  const deletePost = async (id) => {
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(`https://blog-website-backend-guxe.onrender.com/posts/${id}`, {
        method: "DELETE",
        headers: {
          "Authorization": `Bearer ${token}`
        }
  ...
  const likePost = async (id, username) => {
    try {
      ...
      const response = await fetch(`https://blog-website-backend-guxe.onrender.com/posts/${id}/like`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
  ...
  const addComment = async (id, commentData) => {
    try {
      ...
      const response = await fetch(`https://blog-website-backend-guxe.onrender.com/posts/${id}/comment`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
